...
namespace Interneuron.Autonomic.Controllers
{
    ...
    public class EWSController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("[action]/{observationEventId}/{allowPartial?}")]
        public ActionResult<string> CalculateEWS(string observationEventId, bool allowPartial = false)
        {
            ...
            {
                //NEWS2 scale
                ewsResponse = EWSCalculator.CalculateNEWS2Score(obsEvent, allowPartial);
            }
